...
#define STRING_CONFIG_H_AUTHOR "(Magnus Kvevlander)" //Who made the changes.
...
// E3D v5 Hot End with Original K8200 12V Heat Element
    #define  DEFAULT_Kp 17.71
    #define  DEFAULT_Ki 1.20
    #define  DEFAULT_Kd 65.29
#endif // PIDTEMP
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -15.8  
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 76 ,10} // X,Y,Z Axis Extend and Retract angles
